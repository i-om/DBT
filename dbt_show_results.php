...
//$num_Responses = count($search_results);
 ...
 $query="Select * FROM `admin` LEFT JOIN `plant` ON `admin`.`admin_id`=`plant`.`admin_id` LEFT JOIN `results` ON `results`.`admin_id`=`plant`.`admin_id`";
         ...
         <table id='idviewtbl' class='classTable' border='1'>
                    <tr height='40px' class='classRow'>
                        ...
                        for ($ii=0; $ii<$count_id; $ii++)
                        {
                            ...
                            <td><table border='1'>
                            <tr>
                            <td width='100' ><label id='idinvestigatorname' class='classLabel' style='color:red;'>Name</label></td>
                            <td width='150'><label id='idinvestigatoraddress' class='classLabel' style='color:green;'>Address</label></td>
                            </tr>";
